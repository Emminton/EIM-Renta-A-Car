...
namespace EIMRentaaCar.Pages.Reportes
{
    public class ReportVentas
    {
        ...
        List<Ventas> lista = VentasBLL.GetList(v => true);
        ...
        public byte[] Reporte()
        {
            ...
            anchoColumnas[3] = 100;//Usuario
            anchoColumnas[4] = 50; //Cuota
            anchoColumnas[5] = 80; //Monto
            anchoColumnas[6] = 80; //Monto por cuotas
        ...
        private void ReportBody()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("Cuotas", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.LightGray;
            pdfTable.AddCell(pdfCell);
            ...
            pdfCell = new PdfPCell(new Phrase("Monto por cuotas", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.LightGray;
            pdfTable.AddCell(pdfCell);
            ...
            foreach (var item in lista)
            {
                ...
                pdfCell = new PdfPCell(new Phrase(item.FechaVenta.ToString("dd/MM/yyyy"), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);
                ...
                pdfCell = new PdfPCell(new Phrase(item.Cuotas.ToString(), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);

                pdfCell = new PdfPCell(new Phrase(item.MontoTotal.ToString("N2"), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);

                pdfCell = new PdfPCell(new Phrase(item.MontoCuotas.ToString("N2"), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);
