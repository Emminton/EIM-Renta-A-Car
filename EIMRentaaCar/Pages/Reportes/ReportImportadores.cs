...
{
    public class ReportImportadores
    {
        int columnas = 5;
        ...
        List<Importadores> lista = ImportadoresBLL.GetList(i => true);
        ...
        public byte[] Reporte()
        {
            ...
            anchoColumnas[2] = 100;//nombre
            anchoColumnas[3] = 95; //email
            anchoColumnas[4] = 80; //Telefono
        ...
        private PdfPTable setPageTitle()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("Reporte de Importadores", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.Colspan = 2;
            pdfCell.Border = 0;
            pdfCell.ExtraParagraphSpace = 0;
