...
namespace EIMRentaaCar.Pages.Reportes
{
    public class ReportPagoRenta
    {
        ...
        List<PagoRentas> lista = PagoRentasBLL.GetList(p => true);
        ...
        private PdfPTable setPageTitle()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("Reporte de Pago de Rentas", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.Colspan = 2;
            pdfCell.Border = 0;
            pdfCell.ExtraParagraphSpace = 0;
        ...
        private void ReportBody()
        {
            ...
            {
                num++;
                pdfCell = new PdfPCell(new Phrase(item.PagoRentaId.ToString(), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
