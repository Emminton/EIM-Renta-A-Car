...
namespace EIMRentaaCar.Pages.Reportes
{
    public class ReportVehiculo
    {
        ...
        public byte[] Reporte()
        {
            ...
            anchoColumnas[3] = 60; //Marca
            anchoColumnas[4] = 60; //Modelo
            anchoColumnas[5] = 60; //Año
            anchoColumnas[6] = 60; //VIN
            anchoColumnas[7] = 90; //Importador
        ...
        private PdfPTable setPageTitle()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("Reporte de Vehiculo", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.Colspan = 2;
            pdfCell.Border = 0;
            pdfCell.ExtraParagraphSpace = 0;
